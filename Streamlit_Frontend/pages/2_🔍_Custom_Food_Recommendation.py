...
st.set_page_config(page_title="Health condition Diet Recommendation", page_icon="🔍",layout="wide")
...
title="<h1 style='text-align: center;'>Health condition Diet Recommendation</h1>"
